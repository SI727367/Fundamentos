...
HD_PWD='D:/OneDrive - ITESO/- Semestre 4/Fundamentos-de-Sistemas-Digitales-Vivado/SumadorRestadorNBits/SumadorRestadorNBits.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log SRNB.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source SRNB.tcl
