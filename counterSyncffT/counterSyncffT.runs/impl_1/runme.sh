...
HD_PWD='D:/OneDrive - ITESO/- Semestre 4/Fundamentos-de-Sistemas-Digitales-Vivado/counterSyncffT/counterSyncffT.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log counter7Seg.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source counter7Seg.tcl -notrace
