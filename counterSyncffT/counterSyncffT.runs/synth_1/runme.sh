...
HD_PWD='D:/OneDrive - ITESO/- Semestre 4/Fundamentos-de-Sistemas-Digitales-Vivado/counterSyncffT/counterSyncffT.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log counter7Seg.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source counter7Seg.tcl
