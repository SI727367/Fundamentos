...
HD_PWD='D:/OneDrive - ITESO/- Semestre 4/Fundamentos-de-Sistemas-Digitales-Vivado/Gates/Gates.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log gatesTB.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source gatesTB.tcl
