...
HD_PWD='D:/OneDrive - ITESO/- Semestre 4/Fundamentos-de-Sistemas-Digitales-Vivado/SumadorCompleto/SumadorCompleto.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log SumadorC.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source SumadorC.tcl -notrace
