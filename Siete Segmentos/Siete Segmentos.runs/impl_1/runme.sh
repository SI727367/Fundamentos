...
HD_PWD='D:/OneDrive - ITESO/- Semestre 4/Fundamentos-de-Sistemas-Digitales-Vivado/Siete Segmentos/Siete Segmentos.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log bin7seg.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source bin7seg.tcl -notrace
