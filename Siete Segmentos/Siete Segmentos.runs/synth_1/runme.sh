...
HD_PWD='D:/OneDrive - ITESO/- Semestre 4/Fundamentos-de-Sistemas-Digitales-Vivado/Siete Segmentos/Siete Segmentos.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log bin7seg.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source bin7seg.tcl
