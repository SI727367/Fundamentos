...
read_verilog -library xil_defaultlib {{D:/OneDrive - ITESO/- Semestre 4/Fundamentos-de-Sistemas-Digitales-Vivado/Alarma/Alarma.srcs/sources_1/new/Alarma.v}}
...
set_property used_in_implementation false [get_files {{D:/OneDrive - ITESO/- Semestre 4/Fundamentos-de-Sistemas-Digitales-Vivado/Alarma/Basys-3-Master.xdc}}]

set_param ips.enableIPCacheLiteLoad 1
close [open __synthesis_is_running__ w]

synth_design -top Alarma -part xc7a35ticpg236-1L


# disable binary constraint mode for synth run checkpoints
set_param constraints.enableBinaryConstraints false
write_checkpoint -force -noxdef Alarma.dcp
create_report "synth_1_synth_report_utilization_0" "report_utilization -file Alarma_utilization_synth.rpt -pb Alarma_utilization_synth.pb"
