...
HD_PWD='D:/OneDrive - ITESO/- Semestre 4/Fundamentos-de-Sistemas-Digitales-Vivado/Alarma/Alarma.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Alarma.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Alarma.tcl -notrace
