...
HD_PWD='D:/OneDrive - ITESO/- Semestre 4/Fundamentos-de-Sistemas-Digitales-Vivado/Sumador4bits/Sumador4bits.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log sumador4B.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source sumador4B.tcl -notrace
