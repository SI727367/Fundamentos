...
HD_PWD='D:/OneDrive - ITESO/- Semestre 4/Fundamentos-de-Sistemas-Digitales-Vivado/Siete Segmentos POS/Siete Segmentos POS.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Siete_POS.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Siete_POS.tcl
