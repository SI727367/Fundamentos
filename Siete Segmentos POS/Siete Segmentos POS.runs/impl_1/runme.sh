...
HD_PWD='D:/OneDrive - ITESO/- Semestre 4/Fundamentos-de-Sistemas-Digitales-Vivado/Siete Segmentos POS/Siete Segmentos POS.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Siete_POS.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Siete_POS.tcl -notrace
