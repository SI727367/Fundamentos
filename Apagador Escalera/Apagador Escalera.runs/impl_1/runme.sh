...
HD_PWD='D:/OneDrive - ITESO/- Semestre 4/Fundamentos-de-Sistemas-Digitales-Vivado/Apagador Escalera/Apagador Escalera.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log ApagadorE.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source ApagadorE.tcl -notrace
