...
HD_PWD='D:/OneDrive - ITESO/- Semestre 4/Fundamentos-de-Sistemas-Digitales-Vivado/Apagador Escalera/Apagador Escalera.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log ApagadorE.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source ApagadorE.tcl
