...
HD_PWD='D:/OneDrive - ITESO/- Semestre 4/Fundamentos-de-Sistemas-Digitales-Vivado/Sumador4bits/Sumador4bits.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log sumador4B.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source sumador4B.tcl
